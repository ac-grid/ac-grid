...
|-----|------|------|----------------|------|------|------|
| [0002](./completed/0002-sorting-feature.md) | 排序功能 | ✔️ 已完成 (Phase 1) | ~65% | 0.1.0 | Albert Li | 2026-01-31 |
| [0003](./0003-filtering-feature.md) | 过滤功能 | ✅ 已实现 | 待评估 | 0.1.0 | Albert Li | 2026-01-24 |
